...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2026 at 08:28 PM
...
(24, 1, 11, NULL, '2026-04-21 18:28:43', 'Product shown changed from (#10) to (#11);'),
(25, 1, 10, NULL, '2026-04-21 18:29:21', 'Product shown changed from (#11) to (#10);'),
(26, 1, 11, NULL, '2026-04-21 18:35:45', 'Product shown changed from (#10) to (#11);'),
(27, 1, NULL, NULL, '2026-04-21 18:37:37', 'Product shown changed from (#11) to (#NULL);'),
(28, 1, 11, NULL, '2026-04-21 18:37:45', 'Product shown changed from (#) to (#11);'),
(29, 1, 10, NULL, '2026-04-21 18:37:50', 'Product shown changed from (#11) to (#10);'),
(30, 1, 11, NULL, '2026-04-21 18:43:03', 'Product shown changed from (#10) to (#11);'),
(31, 1, 10, NULL, '2026-04-21 18:43:21', 'Product shown changed from (#11) to (#10);'),
(32, 1, 11, NULL, '2026-04-21 18:47:28', 'Product shown changed from (#10) to (#11);'),
(33, 1, 10, NULL, '2026-04-21 19:22:35', 'Product shown changed from (#11) to (#10);'),
(34, 1, 11, NULL, '2026-04-21 19:23:08', 'Product shown changed from (#10) to (#11);'),
(35, 1, 10, NULL, '2026-04-25 15:33:57', 'Product shown changed from (#11) to (#10);'),
(36, 1, 11, NULL, '2026-04-25 15:34:34', 'Product name: Piletina -> Piletinaaa; '),
...
(41, 1, 11, NULL, '2026-04-26 00:58:32', 'Product shown changed from (#10) to (#11);'),
(42, 1, 10, NULL, '2026-04-26 01:00:15', 'Product shown changed from (#11) to (#10);'),
(43, 1, 11, NULL, '2026-04-26 01:10:01', 'Product shown changed from (#10) to (#11);'),
(44, 1, 10, NULL, '2026-04-26 01:10:11', 'Product shown changed from (#11) to (#10);'),
(45, 1, 11, NULL, '2026-04-26 13:57:03', 'Product shown changed from (#10) to (#11);'),
...
(49, 1, 11, NULL, '2026-04-26 13:59:38', 'Product shown changed from (#10) to (#11);'),
...
(53, 1, 11, NULL, '2026-04-26 15:44:11', 'Product shown changed from (#10) to (#11);'),
...
(58, 1, 11, NULL, '2026-04-26 16:20:04', 'Product shown changed from (#10) to (#11);'),
(59, 1, 10, NULL, '2026-04-26 16:20:27', 'Product shown changed from (#11) to (#10);'),
(60, 1, 11, NULL, '2026-04-26 16:29:16', 'Product shown changed from (#10) to (#11);'),
(61, 1, 11, NULL, '2026-04-26 16:32:39', 'Price: 4.00 -> 5; '),
(62, 1, 10, NULL, '2026-04-26 16:40:48', 'Product shown changed from (#11) to (#10);'),
(63, 1, 11, NULL, '2026-04-26 16:41:04', 'Product shown changed from (#10) to (#11);'),
(64, 1, 10, NULL, '2026-04-26 16:42:22', 'Product shown changed from (#11) to (#10);'),
(65, 1, 11, NULL, '2026-04-26 16:42:29', 'Product shown changed from (#10) to (#11);'),
(66, 1, 11, NULL, '2026-04-26 16:42:37', 'Deleted product Piletinaaa with price: 5.00'),
(67, 1, 10, NULL, '2026-04-26 16:42:47', 'Deleted product Kava with price: 2.50'),
(68, 1, 11, NULL, '2026-04-26 19:10:05', 'Deleted product Piletinaaa with price: 5.00'),
...
(73, 1, 11, NULL, '2026-04-26 19:30:37', 'Product shown changed from (#10) to (#11);'),
...
(77, 1, 11, 67, '2026-04-26 19:41:43', 'Product shown changed from (#) to (#11);');
...
INSERT INTO `products` (`id_product`, `displaying_name`, `name`, `descr`, `price`, `price_per_kg`, `currency_code`, `barcode`, `last_price_change`, `version`, `discount_per`, `discount_end`) VALUES
(10, 'Kava', 'Kava', 'Nema', 2.50, 8.00, 'EUR', '1147211147211', '2026-04-26 16:42:16', 1, 20.00, '2026-06-17 05:00:00'),
(11, 'Piletina', 'Piletinaaa', 'Nema', 5.00, 20.00, 'EUR', '0987654321999', '2026-04-26 19:30:28', 1, 20.00, '2026-04-26 07:34:00');
...
--
ALTER TABLE `logs`
  MODIFY `id_log` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
